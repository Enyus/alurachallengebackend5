...
var userController = {
    list: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    users = _a.sent();
                    return [2 /*return*/, res.status(202).json({ users: users })];
                case 2:
                    error_1 = _a.sent();
                    console.log(error_1);
    ...
    login: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, PRIVATE_KEY, userFromDB, token, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (password != (userFromDB === null || userFromDB === void 0 ? void 0 : userFromDB.password)) {
                        return [2 /*return*/, res.status(404).send("Senha inválida")];
                    }
                    token = jsonwebtoken_1["default"].sign({ user: username }, PRIVATE_KEY, { expiresIn: '60d' });
                    // console.log(token);
                    return [2 /*return*/, res.status(202).json({ token: token })];
                case 3:
                    error_2 = _b.sent();
                    console.log(error_2);
