...
var videoController = {
    ...
    addVideo: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, titulo, descricao, url, videoAdd, error_3;
    ...
    updateVideo: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, _a, titulo, descricao, url, dadosAlterados, videoUpdated, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, res.status(202).send("Vídeo deletado com sucesso.")];
                case 4:
                    error_5 = _a.sent();
                    console.log(error_5);
                    return [2 /*return*/, res.status(404).send("Ocorreu um problema.")];
